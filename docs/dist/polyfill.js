(function () {
	...
	function set$1(target, propertyKey, value, receiver) {
		if(receiver === void 0) {
			try {
				target[propertyKey] = value;
				return true;
	...
	if(!this.Reflect) {
		this.Reflect = {
			...
			set: accessor ? set$1 : set,
			get: accessor ? get$1 : get,
			deleteProperty: accessor ? deleteProperty$1 : deleteProperty
		};
	}
	...
	function fixSet(){
		...
		if(typeof s.size === "function") {
			$inject_Object_defineProperty(Set$1.prototype, 'size', {
				get: function() {
	...
	function URL$2(relativePath, absolutePath) {
		var url = new URL$1(relativePath, absolutePath);
