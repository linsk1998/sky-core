(function() {
	...
	function getOwnPropertySymbols$2(obj) {
		var arr = [];
		for(var key in obj) {
	...
	Symbol$5.isConcatSpreadable = "@@isConcatSpreadable";
	Symbol$5.match = "@@match";
	Symbol$5.matchAll = "@@matchAll";
	Symbol$5.replace = "@@replace";
	Symbol$5.search = "@@search";
	Symbol$5.species = "@@species";
	Symbol$5.split = "@@split";
	Symbol$5.toPrimitive = "@@toPrimitive";
	Symbol$5.toStringTag = "@@toStringTag";
	Symbol$5.unscopables = "@@unscopables";
	...
	var getOwnPropertyDescriptor$3 = Object$1.getOwnPropertyDescriptor;
	...
	function getOwnPropertyDescriptor$2(obj, prop) {
		...
		if(obj instanceof Object) {
			return getOwnPropertyDescriptor$2.apply(Object, arguments);
		} else {
			return getOwnPropertyDescriptor$3.apply(Object, arguments);
		}
	}
	...
	QUnit.test('Function#@@hasInstance', function(assert) {
		...
		assert.ok(Function[$inject_Symbol_hasInstance](function() {
			/* empty */
		}));
