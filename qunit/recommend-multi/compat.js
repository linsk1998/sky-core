(function () {
	...
	var setPrototypeOf$2 = Object$1.setPrototypeOf;

	var proto = !!setPrototypeOf$2 || '__proto__' in Object.prototype;

	function setPrototypeOf$1(o, proto) {
	  o.__proto__ = proto;
	  var key;
	  for (key in proto) {
	    switch (key) {
	...
	if (!proto) {
	  Object$1.setPrototypeOf = setPrototypeOf$1;
	}
	...
	QUnit.test('Promise#then', function (assert) {
	  ...
	  var FakePromise2 = FakePromise1[_Symbol$4.species] = function (executor) {
	    executor(function () {/* empty */}, function () {/* empty */});
	  };
	...
	if (!_Symbol$2) {
	  window.Symbol = _Symbol$2 = _Symbol$5;
	  _Symbol$2.sham = true;
